...
const errorBag: ErrorContainer = {
  ...
  0: 'InputError', // you can add props with other key-type not specified in the interface!,
};
...
const result2 = add('test', 2);
const result3 = add(90, 'Banstock');
...
// we're not sure if job or data exists
// console.log(data?.job?.title); // still warns but compiles without Error
...
const storedData = userInput && 'DEFAULT'; // only use fallback for null | undefined
